...
package com.github.wkw.recyclerview;
...
public class SuperAdapter<T extends LayoutResId> extends RecyclerView.Adapter<BindingViewHolder> {
    ...
    public void onBindViewHolder(BindingViewHolder holder, int position) {
        ...
        holder.getBinding().setVariable(com.github.wkw.recyclerview.BR.item, item);
        holder.getBinding().setVariable(com.github.wkw.recyclerview.BR.presenter, getPresenter());
